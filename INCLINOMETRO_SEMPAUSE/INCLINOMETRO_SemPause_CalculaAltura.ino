...
void calculo(float media_z, unsigned long dt){

  float s;

  s = (media_z*dt*dt) / 2;  //SETAR DT BASEADO NO INTERVALO DE MEDICAO E DEPOIS COMPARA ESSE NUMERO (soma_posi_z) COM MULTIPLOS DE 0.5
